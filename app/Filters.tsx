...
export default function ModalScreen() {
	...
	return (
		<View style={styles.container}>
			...
			<Dropdown
				style={[styles.dropdown, isFocusCategory && {borderColor: 'blue'}, {backgroundColor: theme.colors.background}]}
			...
			<Dropdown
				style={[styles.dropdown, isFocusSortBy && {borderColor: 'blue'}, {backgroundColor: theme.colors.background}]}
				placeholderStyle={styles.placeholderStyle}
				selectedTextStyle={styles.selectedTextStyle}
				inputSearchStyle={styles.inputSearchStyle}
				iconStyle={styles.iconStyle}
			...
			<View style={{flexDirection: 'row'}}>
				<Button
					style={{...styles.margins, width: '95%'}} icon="filter-remove" mode="outlined"
